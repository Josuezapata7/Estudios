...
const cargarDocumentos = (documentos) => {
	if(documentos.length > 0){
		...
		// 	docActual = documentos[documentos.length - cantidadNueva];
		// 	console.log(docActual.data().numero);
		// }
...
botonSiguiente.addEventListener('click', () => {
	...
	if(cantidadMayor != null){

		cantidadMayor += 4;

	}else{

		cantidadMayor = cantidad + 4;
